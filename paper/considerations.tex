...
\begin{document}
    ...
    \begin{frame}
        ...
        \begin{theorem}
            Assuming every chunk access is tied to an archive which references the chunk and the
            client does not create any manifest files while accessing it.
    ...
    \begin{frame}
        ...
        \begin{proof}
            ...
            a new archive.
            Since ~\ref{theorem:singleclient} limits the amount of pending fossil deletion steps
            to one the chunk may only be recovered once during the access.
            ...
            it to be deleted.
            Should it fail because of the chunk being recovered by a fossil deletion step the chunk
