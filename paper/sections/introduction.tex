...
since the previous backup storage space is wasted by storing redundant data.
Many existing solutions are able to remove redundant data from individual backups
in a process called `deduplication'.
The storage space saved by such an ability can be increased by performing
the deduplication across the maximum number of backups possible.
