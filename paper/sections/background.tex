...
\begin{table}
    \resizebox{\textwidth}{!}{
        \begin{tabular}{ c c c c }
            \toprule
            Approach & Hard links & Full/incremental backups & Content-addressable storage \\
            \midrule
            Deduplication & individual files & changed data & chunks \\
            \midrule
            Transformations & no & yes & yes \\
            \midrule
            Constraints on deletion & no & yes & no \\
            \bottomrule
        \end{tabular}
    }
