...
Deduplication algorithm described by Gilbert et al.~\cite{Duplicacy} was presented.
...
it to existing backup solutions there is still a lot to do when creating a real
alternative to them.
...
While major cloud storage providers such as Amazon S3~\cite{s3} and Google
Cloud Storage~\cite{GoogleCS} claim to provide strong consistency investigating
the interaction of other consistency models with the Lock-Free Deduplication
algorithm may provide opportunities for performance improvements.
